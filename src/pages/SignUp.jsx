    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input className='w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white bg-color-gray-300 rounded-md transition ease-in-out'
             type="name" 
             id='name' 
             value={name} 
             onChange={onChange} 
            ...
            <div className='relative mb-6'>
              <input className='w-full px-4 py-2 text-xl text-gray-700 bg-white bg-color-gray-300 rounded-md transition ease-in-out'
